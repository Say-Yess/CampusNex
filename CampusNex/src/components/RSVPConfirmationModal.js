                ...
                <div className="p-6">
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 mb-6">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <div className="font-semibold text-gray-900">Google Calendar Integrate</div>
                                <div className="text-xs text-gray-600">
                                    Automatically Sync This Event To Your Google Calendar With All Details, Location, And Reminders.
                                </div>
                            </div>
                        </div>
                        <button
                            onClick={() => setAddToCalendar(!addToCalendar)}
                            className={`w-full py-2 px-4 rounded-lg font-medium transition-colors ${addToCalendar
                        ...
                        >
                            <div className="flex items-center justify-center gap-2">
                                ...
                                {addToCalendar ? 'Added to Calendar' : 'Add To Google Calendar'}
                            </div>
                        </button>
                    </div>
