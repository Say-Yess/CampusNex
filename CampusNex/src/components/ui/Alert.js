...
const Alert = ({
    ...
    // Base classes
    const baseClasses = "relative flex p-4 rounded-lg";
      ...
      `}
        ...
        >
            ...
            {dismissible && onDismiss && (
                <button
                    type="button"
                    className="absolute top-4 right-4 ml-auto inline-flex items-center justify-center w-4 h-4 text-neutral-400 hover:text-neutral-500"
                    onClick={onDismiss}
                    aria-label="Close"
                >
